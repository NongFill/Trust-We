        ...
        >
            ...
            <View style={styles.timeRow}>
              <Text style={styles.timeLabel}>
                {data.storeStatus === "open"
                  ? `เปิดรับฝาก (${formatTime(data.openHour)} - ${formatTime(
                      data.closeHour
                    )})`
                  : "ปิดร้าน"}
              </Text>
          ...
          <Card containerStyle={styles.cardBox2}>
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <View style={styles.tableCellWrapper}>
                      <Text style={styles.tableCell1}>
                        รายได้สุทธิต่อสัปดาห์
                      </Text>
                      <Text style={[styles.tableCell1, { marginTop: 2 }]}>
                        ฿ {data.weeklyIncome || 0}
                      </Text>
                    </View>
                    <View style={styles.tableCellWrapperLast}>
                      <Text style={styles.tableCell2}>ยอดรับฝากต่อสัปดาห์</Text>
                      <Text style={[styles.tableCell2, { marginTop: 2 }]}>
                        {data.weeklyDeposits || 0}
                      </Text>
                    </View>
                  </View>
                </View>
            ...
            <View style={styles.menuContainer}>
              ...
              <TouchableOpacity
                style={styles.menuItem}
                onPress={() => navigation.navigate("Detail_Money")}
              >
              ...
              <TouchableOpacity
                style={styles.menuItem}
                onPress={() => navigation.navigate("Detail_Deposit")}
              >
              ...
              <TouchableOpacity
                style={styles.menuItem}
                onPress={() => navigation.navigate("Detail_History")}
              >
...
const styles = StyleSheet.create({
  ...
  timeLabel: { fontSize: 16, color: "#000000" ,left: 5},
  adjustButton: {
    backgroundColor: "#fff",
    borderColor: "#fff",
    borderWidth: 1,
  ...
  tableCell1: { fontSize: 14 },
  tableCell2: { fontSize: 14 },
